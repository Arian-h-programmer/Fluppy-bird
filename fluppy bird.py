...
pygame.time.set_timer(create_flap, 20)
pygame.time.set_timer(create_pipe, 1200)
# Arian hajinezhad #
background_image = pygame.transform.scale2x(pygame.image.load('bg2.png'))
floor_image = pygame.transform.scale2x(pygame.image.load('floor.png'))
bird_image_down = pygame.transform.scale2x(pygame.image.load('red_bird_down_flap.png')) 
bird_image_mid = pygame.transform.scale2x(pygame.image.load('red_bird_mid_flap.png'))
bird_image_up = pygame.transform.scale2x(pygame.image.load('red_bird_up_flap.png')) 
bird_list = [bird_image_down, bird_image_mid, bird_image_up]
bird_image = bird_list[bird_list_index]
pipe_image = pygame.transform.scale2x(pygame.image.load('pipe_red.png'))
game_over_image = pygame.transform.scale2x(pygame.image.load('message.png'))
